      ...
      <div className="border-r border-border flex-1 flex flex-col">
        ...
        <div className="p-4 space-y-10 bg-light-bg rounded-2xl p-3 mx-6 mb-[40px] shadow-[0_1px_8px_0_rgba(0,0,0,0.1)]">
          ...
          <div className="flex items-center justify-between">
            <button className="inline-flex items-center gap-2 px-4 py-2.25 bg-warning-bg text-warning-text rounded-lg text-[10px] uppercase shadow-[0_1px_8px_0_rgba(0,0,0,0.08)]">
